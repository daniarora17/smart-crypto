...
export class SharedServiceService {
  ...
  allCoinUrl: any = {
    ...
    bitStampUsd: 'https://www.bitstamp.net/api/v2/ticker/ltcusd/',
    ...
    cryptocompare: 'https://min-api.cryptocompare.com/data/pricemulti?fsyms=ETH,DASH,LTC,XRP&tsyms=BTC,USD',
  ...
  allCoinObservable = Observable.forkJoin(
    ...
    this.http.get(this.allCoinUrl.bitStampUsd).map((res: Response) => res.json())
